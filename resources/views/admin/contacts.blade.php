...
<section class="groupsAdmin">
    <div class="container">
        <div class="contactsAdmin__header">
            <div class="groupsAdmin__title">Контакты</div>
            <div class="contactsAdmin__header_wrapper">
                <div class="contactsAdmin__lang">Eng</div>
                <div class="contactsAdmin__lang contactsAdmin__lang_active">Руc</div>
                <div class="contactsAdmin__lang">Укр</div>
            </div>
        </div>
        <form action="POST">
            <div class="contactsAdmin__row">
                <div class="contactsAdmin__mainBlock">
                    ...
                    <input class="contactsAdmin__input" placeholder="Телефон №1" value="+38 (067) 686 92 91">
                    <div class="contactsAdmin__label">Телефон №2</div>
                    <input class="contactsAdmin__input" placeholder="Телефон №2" value="+38 (050) 332 66 44">
                </div>
                <div class="contactsAdmin__mainBlock">
                    <div class="contactsAdmin__mainBlock_title">
                ...
                <div class="contactsAdmin__mainBlock">
                    ...
                    <textarea class="contactsAdmin__input contactsAdmin__mainBlock_textarrea" placeholder="Адреса">123Украина, г. Киев, ул. Юрия Ильенко 81а</textarea>
                </div>
                <div class="contactsAdmin__mainBlock">
                    <div class="contactsAdmin__mainBlock_title">
                        <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="contactsAdmin__mainBlock_social contactsAdmin__mainBlock_social-fc">
                        ...
                        <input type="text" class="contactsAdmin__input" placeholder="link">
                    </div>
