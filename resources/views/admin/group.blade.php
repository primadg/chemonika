...
<section class="groupsAdmin">
    <div class="container">
        <div class="groupsAdmin__header">
            <div class="groupsAdmin__title">Групи продуктів</div>
...
<script>
    ...
    addGroup.onclick = (e) => {
        ...
        let table = e.target.closest('.groupsAdmin').querySelector('.groupsAdmin__content');
