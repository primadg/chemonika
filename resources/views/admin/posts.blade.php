        ...
        <div class="post__container">
            ...
            <div class="post__block">
                ...
                <div class="post__block_btns">
                    ...
                    <div data-id="{{$product->id}}" class="post__block_btns-togller @if(!$product->visible) post__block_btns-togller-active @endif">
...
<script>
    ...
    visibleProduct.forEach(item => {
        item.onclick = (e) => {
            ...
            sendVisibleRequest($(e.currentTarget).attr("data-id"))
        }
    })
