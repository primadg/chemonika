        ...
        <form action="{{env('APP_URL')}}/save_contact" method="POST">
            ...
            <div class="contactsAdmin__row">
                <div class="contactsAdmin__mainBlock">
                    ...
                    <input name="tel1" class="contactsAdmin__input" placeholder="Телефон №1" value="{{$contact->tel1}}">
                    <div class="contactsAdmin__label">Телефон №2</div>
                    <input name="tel2" class="contactsAdmin__input" placeholder="Телефон №2" value="{{$contact->tel2}}">
                </div>
                <div class="contactsAdmin__mainBlock">
                    <div class="contactsAdmin__mainBlock_title">
                ...
                <div class="contactsAdmin__mainBlock">
                    ...
                    <div class="contactsAdmin__mainBlock_social contactsAdmin__mainBlock_social-fc">
                        ...
                        <input type="text" name="link_tg" class="contactsAdmin__input" value="{{$contact->link_tg}}" placeholder="link">
                    </div>
                    <div class="contactsAdmin__mainBlock_social">
                        ...
                        <input type="text" name="link_skype" class="contactsAdmin__input"  value="{{$contact->link_skype}}" placeholder="link">
                    </div>
                    <div class="contactsAdmin__mainBlock_social">
                        <div class="contactsAdmin__mainBlock_social-imageWrapper">
                        ...
                        <input type="text" name="link_facebook" class="contactsAdmin__input"  value="{{$contact->link_facebook}}" placeholder="link">
                    </div>
                </div>
            </div>
