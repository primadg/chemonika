        ...
        <div class="header__wrapper">
            ...
            <div class="header__info">
                <div class="header__info_contact">
                    <a class="header__info_contact-link header__active_link link__about" href="{{env('APP_URL')}}">О
                        нас</a>
                </div>
                <div class="header__info_contact">
                ...
                <div class="header__info_lang">
                    <div class="header__info_lang-chosen">RUS</div>
...
<div class="burger__menu">
    ...
    <a href="{{env('APP_URL').'/products'}}"
       class="burger__menu_list burger__menu_list-middle burger__menu_list-products">Продукция</a>
            ...
            <div class="row promo__row">
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="promo__descr">
                        Поставки химического сырья из Азии, Европы, Америки для различных отраслей промышленности:
                        пищевой, косметической, металлургической, нефтегазовой, лакокрасочной, полимерной, строительной
                        и других.
                    </div>
            ...
            <div class="row">
                <div class="col-lg-7 col-md-12">
                    ...
                    <div class="about__descr">
                        ...
                        <div class="about__descr_text">Основным видом деятельности нашей компании является поставка
                            пищевых ингредиентов от ведущих производителей.
                        </div>
                    </div>
                    <div class="about__descr_bottom">
                        <div class="about__descr_text">Преимущества работы с нашей компанией:</div>
                        <ul>
                            <li>Мы работаем напрямую с ведущими производителями, поэтому можем предложить нашим клиентам
                                лучшее качество и лучшие условия сотрудничества
                            </li>
                            <li>Открытость</li>
                            <li>Оперативность</li>
                        </ul>
