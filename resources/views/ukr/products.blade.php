        ...
        <div class="header__wrapper">
            ...
            <div class="header__info">
                <div class="header__info_contact">
                    <a class="header__info_contact-link link__about" href="index.html">Про нас</a>
                </div>
                <div class="header__info_contact">
                    <a class="header__info_contact-link header__active_link link__products" href="production.html">Продукція</a>
                </div>
                <div class="header__info_contact">
            ...
            <div class="row">
                ...
                <div class="secondPage__filter_group-wrapper">
                    ...
                    <div class="secondPage__filter_group">
                        ...
                        <div class="rep">
                            <select name="spread" id="spread" class="custom-select sources1" placeholder="Оберіть">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 secondPage__goods_card">
                            ...
                            <div class="secondPage__goods_card-main">
                                ...
                                <div class="products__block_main-btn secondPage__goods_card-btn">
                                    <div><a href="{{route('products.show', $product->id)}}">Дизнатися більше</a></div>
