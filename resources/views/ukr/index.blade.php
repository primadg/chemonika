            ...
            <div class="col-lg-10 banner__main">
                <div class="banner__main_block">
                    <div class="banner__main_title">
                        Ми пропонуємо продукцію лише перевірених виробників зі світовим ім'ям
                    </div>
                    <div class="banner__main_descr">
                        Наша місія – Залишатися високоефективною компанією – лідируючим дистрибьютором якісних хімічних
                        матеріалів. Постійно вдосконалюючи свої професійні навички та вміння, ми розвиваємося разом з
                        партнерами!
                    </div>
