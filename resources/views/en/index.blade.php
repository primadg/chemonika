            ...
            <div class="header__wrapper">
                ...
                <div class="header__info">
                    <div class="header__info_contact">
                        <a class="header__info_contact-link header__active_link link__about" href="{{env('APP_URL')}}">About us</a>
                    </div>
                    <div class="header__info_contact">
                        <a class="header__info_contact-link link__products" href="{{env('APP_URL').'/products'}}">Product</a>
                    </div>
                    <div class="header__info_contact">
                        ...
                        <div class="products__block col-md-4 col-sm-6 col-12">
                            ...
                            <div class="products__block_main">
                                ...
                                <div class="products__block_main-btn">
                                    <div onclick="location.href=' {{route("product.show",$product->id)}}'" >Show more</div>
                                    <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10.59 0.59L6 5.17L1.41 0.59L0 2L6 8L12 2L10.59 0.59Z" fill="#219653"/>
                                    </svg>
                                </div>
