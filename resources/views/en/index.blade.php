...
<body>
            ...
            <div class="header__wrapper">
                ...
                <div class="header__info">
                    <div class="header__info_contact">
                        <a class="header__info_contact-link header__active_link link__about" href="index.blade.php">About us</a>
                    </div>
                    <div class="header__info_contact">
                        <a class="header__info_contact-link link__products" href="productionEn.html">Product</a>
                    </div>
                    <div class="header__info_contact">
    ...
    <div class="burger__menu">
        <a href="index.blade.php" class="burger__menu_list burger__menu_list-about">About us</a>
             ...
             <div class="row promo__row">
                 <div class="col-lg-6 col-md-6">
                     ...
                     <div class="promo__suggestions">
                         <div class="promo__suggestions_hov">Our proposals</div>
                         <svg class="header__info_button-svg" width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                 ...
                 <div class="row">
                     <div class="col-lg-7 col-md-12">
                         ...
                         <div class="about__descr">
                             ...
                             <div class="about__descr_text">alpavit_logo Alpavit Kaiser Champignon Hofmeister GmbH - lactose pharmaceutical and food.</div>
                             <div class="about__descr_text">index  Accent Microcell, India - MCC, croscarmellose, magnesium stearate.</div>
                             <div class="about__descr_text">logo2 OJSC Schuchinsk MSZ, Belarus - KSB-UF80, lactose.</div>
                         </div>
                 ...
                 <div class="col-lg-10 banner__main">
                     <div class="banner__main_block">
                         ...
                         <div class="banner__main_choose">
                             <div class="banner__main_choose-hov">Select your segment </div>
