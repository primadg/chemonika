        ...
        <div class="header__wrapper">
            ...
            <div class="header__info">
                <div class="header__info_contact">
                    <a class="header__info_contact-link header__active_link link__about" href="{{env('APP_URL')}}">About
                        us</a>
                </div>
                <div class="header__info_contact">
                    <a class="header__info_contact-link link__products"
                       href="{{env('APP_URL').'/products'}}">Product</a>
                </div>
                <div class="header__info_contact">
...
<div class="burger__menu">
    ...
    <a href="{{env('APP_URL').'/products'}}"
       class="burger__menu_list burger__menu_list-middle burger__menu_list-products">Product</a>
            ...
            <div class="row promo__row">
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="promo__descr">
                        Supplies of chemical raw materials from Asia, Europe, America for various industries: food,
                        cosmetics, metallurgy, oil & gas, paint & coatings, polymer, construction and others
                    </div>
                    <div class="promo__suggestions">
                        <div onclick="location.href='{{env("APP_URL")."/products"}}'" class="promo__suggestions_hov">Our
                            proposals
                        </div>
                        <svg class="header__info_button-svg" width="12" height="8" viewBox="0 0 12 8" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="store__wrapper">
                <div class="store__block">
                    <div class="store__block_square">
                        <img src="{{env("APP_URL")}}/img/images/1_storage.png" alt="Charkiv">
                    </div>
