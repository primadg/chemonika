...
",
        ...
        DB::table('product_ukrs')->insert([
            ...
            'Storage' => "Зберігати в сухому, захищеному від світла місці",
            'Standart' => "Відповідає стандарту  FCCIV, Е420",
            'description' => "Сорбінова кислота являє собою дрібні кристали без кольору та запаху, дуже незначно розчинні в воді, речовина не токсична і не є канцерогеном. В харчовій промисловості сорбінова кислота E 200 використовується як консервант, мета якого збільшення терміну зберігання продуктів.",
        ]);
        DB::table('product_rus')->insert([
            ...
            'img' => '/img/images/p/p6.png',
            'pos_id' => 6,
            'Product_usage' => "Применяется с целью консервирования и предотвращения плесневения безалкогольных напитков, плодово-ягодных соков, хлебопекарных, кондитерских изделий (мармелад, джемы, варенье, кремы), а также зернистой икры, сыров, полукопченых колбас.
...
/// Пшеничная клейковина
        ...
        DB::table('contact_table_en')->insert([
            "id" => 1,
            "tel1" => '{"0":"+38 (067) 686 92 91", "1":"+38 (050) 332 66 44"}',
            "tel2" => "+38 (050) 332 66 44",
            "email1" => '{"0":"akabanov@chemonika.com.ua"}',
            "email2" => "",
        ...
        DB::table('contact_table_ukr')->insert([
            ...
            "email1" => '{"0":"akabanov@chemonika.com.ua"}',
            "email2" => "",
            "adrs" => "Україна, м. Київ, вул. Юрія Іллєнка 81а"
        ]);
